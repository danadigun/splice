product.controller('ViewStockController', function ($scope, $http, $state, $stateParams, $mdToast) {
    ...
    var loadStockItems = function () {
        $http.get('/api.ashx/api/sales/stock?stockId=' + $stateParams.stockId).then(function (response) {
    ...
    $scope.addProduct = function () {
        ...
        $http.post('/api.ashx/api/sales/stock', { item: $scope.product, stockId: $stateParams.stockId })
    ...
    $scope.removeStock = function () {
        $http.delete('/api.ashx/api/sales/stock?stockId='+$stateParams.stockId)
             .then(function (response) {
