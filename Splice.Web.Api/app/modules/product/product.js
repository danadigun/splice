...
product.controller('ManageStockController', function ($scope, $http, $state, $mdToast, $interval) {
    ...
    $scope.createStock = function (stock) {
        $scope.isBusy = true;
        $http.post('api/sales/stock', { stock: $scope.stock })
    ...
    $scope.addItemToStock = function () {
        ...
        $http.post('/api/sales/stock', { stockId: $scope.stockId, item: $scope.product })
           .then(function (response) {
               //error?
           }, function (error) {
    ...
    var loadAddedItems = function () {
        $http.get('/api/sales/stock?stockId=' + $scope.stockId)
         .then(function (response) {
